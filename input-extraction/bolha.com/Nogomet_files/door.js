    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        var imgUrl = "https://script.dotmetrics.net/hit.gif?id=2090&url=" + pageUrl + "&dom=" + domain + "&r=" + rand + "&pvs=" + pvs + "&pvid=" + pvid;
                    ...
                    window.DotMetricsSettings =
                                {
                                    ...
                                    ScriptDebugUrl:  "https://demo-script.dotmetrics.net/Scripts/script.debug-css-test.js?v=e3aeb27d-6a8b-464a-b4a2-7fa790697562",
                                    ...
                                    AdexEnabled: false,
                                    AdexConfigUrl: "https://adex.dotmetrics.net/adexConfig.js?v=144&id=2090",
