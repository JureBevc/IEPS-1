...
def xpath(page, site):
    ...
    if site == "rtv":
        data = dict(
            Author=tree.xpath('//*[@id="main-container"]//*[@class="article-meta"]//div[@class="author-name"]/text()')[
                0].strip(),
            ...
            if title:
                ...
                data.append(dict(
                    ...
                    ListPrice=tree.xpath(
                        f'//table[2]/tbody/tr[1]/td[5]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[@bgcolor][{i}]/td[2]/table//table//tr[1]/td[2]//text()[normalize-space()]')[
                        0].strip(),
                    Price=tree.xpath(
                        f'//table[2]/tbody/tr[1]/td[5]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[@bgcolor][{i}]/td[2]/table//table//tr[2]/td[2]//text()[normalize-space()]')[
                        0].strip(),
                    Saving=tree.xpath(
                        f'//table[2]/tbody/tr[1]/td[5]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[@bgcolor][{i}]/td[2]/table//table//tr[3]/td[2]/span//text()')[
                        0].split()[0].strip(),
        ...
        for i, title in enumerate(titles):
            data.append(dict(
                ...
                Description=tree.xpath(
                    f'//div[@class="content-main"]//ul/li/article//div[@class="entity-description-main"]//text()[normalize-space()]')[
                    i].strip(),
                Price=tree.xpath(
                    f'//div[@class="content-main"]//ul/li/article//div[@class="entity-prices"]//strong[@class="price price--hrk"]/text()[normalize-space()]')[
                          i].strip() + " €",
                PublishedDate=tree.xpath(
                    f'//div[@class="content-main"]//ul/li/article//div[@class="entity-pub-date"]/time/text()[normalize-space()]')[
                    i].strip(),
                ImageUrl=
                tree.xpath(f'//div[@class="content-main"]//ul/li/article/div[@class="entity-thumbnail"]/a/img/@src')[
                    i].strip(),
            ))
    return json.dumps(data)
